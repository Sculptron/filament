...
// === AI ENGINE (NOW CALLS OUR SERVERLESS FUNCTION) ===
  ...
  return (
    <div style={{background:"transparent",minHeight:"100vh",fontFamily:"'Inter',-apple-system,sans-serif",color:"#e0e0e0",position:"relative",zIndex:1}}>
      <div style={{padding:"16px 20px 6px",display:"flex",alignItems:"center",gap:12}}>
        <button onClick={onBack} style={{background:"#0a0a0f99",backdropFilter:"blur(8px)",border:"1px solid #333",color:"#666",borderRadius:8,padding:"6px 14px",fontSize:12,cursor:"pointer"}}>← Back</button>
        </div>
...
}1px solid #333",color:"#888",borderRadius:8,padding:"6px 14px",fontSize:12,cursor:"pointer",letterSpacing:0.5}}>← Back</button>
    ...
    return (
      <div style={{minHeight:"100vh",fontFamily:"'Inter',-apple-system,sans-serif",color:"#e0e0e0",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",padding:24,position:"relative",zIndex:1}}>
        <div style={{position:"absolute",top:20,left:20}}>
          <button onClick={()=>{setGuideStep(-1);setGuideSel([]);}} style={{background:"#0a0a0f99",backdropFilter:"blur(8px)",border:"